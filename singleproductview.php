                        ...
                        <div class="row">
                            <div class="bg-white rounded-2" style="padding: 11px;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 order-lg-1 order-2" id="cview">
                                        <ul>
                                    ...
                                    <div class="col-lg-6 order-3">
                                        <div class="row ">
                                            ...
                                            <hr class="hrbreak1 border border-primary rounded-3" />
                                ...
                                <div class="row">
                                    <div class=" col-12">
                                        <div class="row p-2   justify-content-center">
                                            ...
                                            $s = 1;
                                            $brandrs = Database::search("SELECT `product`.`id` AS `pid`, `product`.`title`,`product`.`qty`, `product`.`price`, `model_has_brand`.`brand_id` FROM `product` LEFT JOIN `model_has_brand` ON product.model_has_brand_id=model_has_brand.id  WHERE product.status_id='" . $s . "' AND model_has_brand.brand_id = '" . $mhb["brand_id"] . "'  LIMIT 4  ");
                                            ...
                                            ?>
                                                        <div class="card me-1" style="width: 18rem;">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                ?>
                                                                <!-- <a class="btn btn-primary p-2" href="<?php echo "singleproductview.php?id=" . ($bdf["pid"]) ?>">View</a>
                                                                <a href="#" class="btn btn-danger p-2">Add to cart</a>
                                                                <a class="ms-2 mt-1 fs-5" onclick="addToWatchlist(<?php echo $bdf['pid']; ?>)"><i class="fas fa-heart mt-2 fs-4 text-black-50"></i></a> -->
                                                            </div>
                                                        </div>
                                            <?php
                                                    }

...
?>
        ...
        <div class="row">
            ...
            <div class="col-10 offset-1  ">
                <div class="row">
                    ...
                    $usersrs = Database::search("SELECT * FROM `user` WHERE `email` != 'adithyawickrama70@gmail.com' AND `email` LIKE '%" . $text . "%' ");
                    $d = $usersrs->num_rows;
                    $row = $usersrs->fetch_assoc();
                    ...
                    $selectedrs = Database::search("SELECT * FROM `user`  WHERE `email` != 'adithyawickrama70@gmail.com' AND `email` LIKE '%" . $text . "%' LIMIT " . $results_per_page . " OFFSET " . $page_first_result . " ");
    ...
    <?php
        ...
        // echo "Please add a email to search.";
    ?>
